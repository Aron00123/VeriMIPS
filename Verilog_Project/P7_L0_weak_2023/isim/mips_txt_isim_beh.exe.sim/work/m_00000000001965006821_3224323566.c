...
#endif
static const char *ng0 = "C:/Users/Aron_/Desktop/lessons/SecondYear1/CO/Verilog_Project/P7_L0_weak_2023/IFU.v";
...
LAB58:    t170 = (t0 + 5704);
    ...
    *((unsigned int *)t180) = (t182 | t176);
    xsi_driver_vfirst_trans(t170, 0, 4);
    t183 = (t0 + 5432);
    *((int *)t183) = 1;
...
LAB19:    if (*((unsigned int *)t47) > *((unsigned int *)t48))
        goto LAB18;
...
LAB25:    memcpy(t81, t53, 8);

LAB26:    memset(t113, 0, 8);
    t114 = (t81 + 4);
...
LAB31:    if (*((unsigned int *)t67) < *((unsigned int *)t68))
        goto LAB30;
...
LAB54:    xsi_vlog_unsigned_bit_combine(t3, 5, t164, 5, t169, 5);
    goto LAB58;

LAB56:    memcpy(t3, t164, 8);
    goto LAB58;

}


extern void work_m_00000000001965006821_3224323566_init()
{
	static char *pe[] = {(void *)Initial_18_0,(void *)Always_22_1,(void *)Cont_34_2,(void *)Cont_35_3,(void *)Cont_36_4,(void *)Cont_37_5};
	xsi_register_didat("work_m_00000000001965006821_3224323566", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000001965006821_3224323566.didat");
