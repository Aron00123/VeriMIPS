...
#endif
static const char *ng0 = "C:/Users/Aron_/Desktop/lessons/SecondYear1/CO/Verilog_Project/P5_L0_weak_2023/MUX.v";
static int ng1[] = {0, 0};
...
LAB92:    t311 = (t163 + 4);
    t312 = *((unsigned int *)t163);
    t313 = *((unsigned int *)t311);
    t314 = (t312 || t313);
    if (t314 > 0)
        goto LAB93;

LAB94:    t317 = *((unsigned int *)t163);
    t318 = (~(t317));
...
LAB98:    if (*((unsigned int *)t163) > 0)
        goto LAB99;

LAB100:    memcpy(t162, t321, 8);
...
LAB97:    xsi_vlog_unsigned_bit_combine(t162, 32, t316, 32, t321, 32);
    goto LAB101;

LAB99:    memcpy(t162, t316, 8);
    goto LAB101;

}


extern void work_m_00000000003495655446_3262371811_init()
{
	static char *pe[] = {(void *)Cont_28_0};
	xsi_register_didat("work_m_00000000003495655446_3262371811", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000003495655446_3262371811.didat");
